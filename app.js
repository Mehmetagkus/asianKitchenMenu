const menu = [
  ...
  },
  {
    ...
    price: 5.99,
    img:
      "https://hips.hearstapps.com/hmg-prod/images/190226-dan-dan-noodles-253-1552085451.jpg",
...
let category = ["All"]
menu.forEach((item) => category.push(item.category))
...
menu.map((item) => {
  document.querySelector(".section-center").innerHTML += `<div class="menu-items col-lg-6 col-sm-12">
...
buttons.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    menuItems.forEach((item) => {
      if (item.children[1].children[0].children[1].innerHTML === category || category === "All") {
